                ...
                <div className="flex min-w-0 items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <button
                      type="button"
                      onClick={copyAddress}
                      className="mt-2 inline-flex max-w-full items-center gap-2 rounded-xl bg-transparent px-0 py-1.5 text-sm font-semibold text-muted-foreground transition hover:text-foreground"
