...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-gradient-logo text-black hover:opacity-90 transition-opacity border-0",
        destructive: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "border border-border bg-surface hover:bg-surface-hover text-foreground",
        secondary: "bg-gradient-logo text-black hover:opacity-80 border-0",
        neutral: "bg-neutral-200 text-gray-900 hover:bg-neutral-300 border-0 dark:bg-neutral-700 dark:text-white dark:hover:bg-neutral-600 transition-colors",
        ghost: "hover:bg-muted text-foreground",
        link: "text-primary underline-offset-4 hover:underline",
        yellow: "bg-yellow-accent text-black hover:bg-yellow-accent/90 font-medium",
      },
      size: {
